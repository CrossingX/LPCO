...
set rc [catch {
  ...
  set_property ip_repo_paths {{e:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.cache/ip}} [current_project]
  set_property ip_output_repo {{e:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.cache/ip}} [current_project]
  add_files -quiet {{E:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.runs/synth_1/top.dcp}}
  add_files -quiet {{E:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.runs/irom_synth_1/irom.dcp}}
  set_property netlist_only true [get_files {{E:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.runs/irom_synth_1/irom.dcp}}]
  read_xdc -mode out_of_context -ref irom {{e:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.srcs/sources_1/ip/irom/irom_ooc.xdc}}
  set_property processing_order EARLY [get_files {{e:/AOften/Computer Organization and Design/lab/vivado5/basys/basys.srcs/sources_1/ip/irom/irom_ooc.xdc}}]

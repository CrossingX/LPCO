...
HD_PWD='E:/AOften/Computer Organization and Design/lab/vivado6/Pipelining/Pipelining.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsPipelineCPU.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MipsPipelineCPU.tcl

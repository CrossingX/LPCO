...
HD_PWD='E:/AOften/Computer Organization and Design/lab/vivado1/addsub/addsub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub8.vds -m64 -mode batch -messageDb vivado.pb -notrace -source addsub8.tcl

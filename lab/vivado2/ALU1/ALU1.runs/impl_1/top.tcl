...
set rc [catch {
  ...
  open_checkpoint {E:/AOften/Computer Organization and Design/lab/vivado2/ALU1/ALU1.runs/impl_1/top.dcp}
  ...
  set_property ip_repo_paths {{e:/AOften/Computer Organization and Design/lab/vivado2/ALU1/ALU1.cache/ip}} [current_project]
  set_property ip_output_repo {{e:/AOften/Computer Organization and Design/lab/vivado2/ALU1/ALU1.cache/ip}} [current_project]
